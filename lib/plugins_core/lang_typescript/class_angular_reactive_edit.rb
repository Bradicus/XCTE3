...
module XCTETypescript
  class ClassAngularReactiveEdit < ClassBase
    ...
    def genFileContent(cls, bld)
      ...
      bld.startBlock('this.' + Utils.instance.get_styled_variable_name(storeServiceVar) + '.create(this.' + clsVar + '.value).subscribe(newItem => ')
      bld.add 'this.item = newItem;'
      bld.endBlock ');'
      bld.midBlock('else')
      bld.startBlock('this.' + Utils.instance.get_styled_variable_name(storeServiceVar) + '.update(this.' + clsVar + '.value).subscribe(newItem => ')
      bld.add 'this.item = newItem;'
      bld.endBlock ');'
      bld.endBlock
      bld.endBlock
