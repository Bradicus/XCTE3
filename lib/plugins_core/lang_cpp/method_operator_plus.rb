...
class XCTECpp::MethodOperatorPlus < XCTEPlugin
  
  def initialize
    @name = "method_operator_plus"
    @language = "cpp"
  ...
  def get_definition(codeClass, cfg)
    ...
    eqString << "/**\n* Returns the result of adding this " << codeClass.name << " to another\n*/\n"
    eqString << "const " << codeClass.name 
...
XCTEPlugin::registerPlugin(XCTECpp::MethodOperatorPlus.new)
